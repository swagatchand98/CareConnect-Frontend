      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-4 sm:mb-6">
          ...
          {notifications.some(notification => !notification.isRead) && (
            <button 
              ...
              className="text-sm text-blue-600 hover:text-blue-800 px-3 py-1 rounded-md border border-blue-200 hover:bg-blue-50 transition-colors"
            >
              Mark all as read
            </button>
          )}
        ...
        {!isLoading && !error && notifications.length === 0 && (
          <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8 text-center">
            ...
            <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-2">No notifications yet</h2>
            <p className="text-sm sm:text-base text-gray-500">You don&apos;t have any notifications at the moment.</p>
          </div>
        )}
          ...
          <div className="bg-white rounded-lg shadow-sm divide-y">
            {notifications.map(notification => (
              <div 
                ...
                className={`p-3 sm:p-4 flex items-start gap-3 sm:gap-4 ${notification.isRead ? 'bg-white' : 'bg-blue-50'}`}
              >
                {/* Notification Icon */}
                <div className="flex-shrink-0">
                  ...
                  {notification.type === 'review' && (
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-yellow-100 flex items-center justify-center">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {notification.type === 'system' && (
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-purple-100 flex items-center justify-center">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <p className="text-sm sm:text-base text-gray-800 leading-relaxed">{notification.content}</p>
                  <p className="text-xs sm:text-sm text-gray-500 mt-1">{formatDate(notification.createdAt)}</p>
                </div>
